...
class PratosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prato" do
    assert_difference('Prato.count') do
      post pratos_url, params: { prato: { codigo: @prato.codigo, descricao: @prato.descricao, ingredientes: @prato.ingredientes } }
    end
  ...
  test "should update prato" do
    patch prato_url(@prato), params: { prato: { codigo: @prato.codigo, descricao: @prato.descricao, ingredientes: @prato.ingredientes } }
